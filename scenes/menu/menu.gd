...
func go_to_web_socket_server(): get_tree().change_scene("res://scenes/web_socket/web_socket_server.tscn")
func go_to_web_socket_client(): get_tree().change_scene("res://scenes/web_socket/web_socket_client.tscn")
